...
public class AdapterTransitionFragment extends Fragment
        implements Transition.TransitionListener, TextToSpeech.OnInitListener {
    // Debugging
    ...
    public static final int REQUEST_SPEECH_TO_TEXT = 100;
...
//                  getActivity().finish();
            ...
            case R.id.action_speak:
                ...
                try {
                    ...
                    Toast.makeText(getActivity(), "Your Device Doesn't Suppoert Speech to Text",
        ...
        switch (requestCode) {
            ...
            case REQUEST_SPEECH_TO_TEXT:
                if((data != null) && (resultCode == RESULT_OK)){
                    ...
                    RcButton rcButton = RcButton.getButton(spokenText.get(0));
                    if(rcButton == null)
                        Toast.makeText(getActivity(), "Unknown Command: " + spokenText.get(0),
                                Toast.LENGTH_LONG).show();
                    else if(!sendBtMessage(Long.toString(rcButton.mCode, 16))) {
...
//          mAbsListView.setSelector(R.color.selector);
    ...
    public void scanDevice() {
        ...
        Intent serverIntent
                = new Intent(getActivity(), com.sdtlab.kkim.irterm3.DeviceListActivity.class);
            ...
            switch (msg.what) {
                ...
                case RcButtonAdapter.MESSAGE_CHECKED_ITEM:
                    if(atFragment != null) {
                        ...
                        RcButton rcButton = RcButton.getButton((int) msg.obj);
                        if(rcButton != null)
                            mTextToSpeech.speak(rcButton.mTitle, TextToSpeech.QUEUE_FLUSH, null, "button");
                    }
                    break;
            }
        }
